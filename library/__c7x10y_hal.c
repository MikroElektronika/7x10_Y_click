...
/**  
@file  __c7x10y_hal.c
@brief   C7X10Y HAL Interface
*/

#include "stdint.h"

/** @section                                         HAL_CFG HAL Configuration
 *  @{                                         *///-----------------------------
...
/** @section                                         HAL_SPI HAL SPI Interface
 *  @{                                         *///-----------------------------
...
/** @section                                         HAL_I2C HAL I2C Interface
 *  @{                                         *///-----------------------------
...
/** @section                                       HAL_UART HAL UART Interface
 *  @{                                       *///-------------------------------
...
/** @section                                       HAL_GPIO HAL GPIO Interface
 *  @{                                       *///-------------------------------

typedef void    (*T_hal_gpioSetFp)(uint8_t); /**< Default GPIO Set Function Pointer */
typedef uint8_t (*T_hal_gpioGetFp)();        /**< Default GPIO Get Function Pointer */

/**
 * @struct T_hal_gpioObj 
 * @brief HAL GPIO Object
 */
typedef struct
{
    T_hal_gpioSetFp      gpioSet[ 12 ];   /**< Set pointers - One per each pin */
    T_hal_gpioGetFp      gpioGet[ 12 ];   /**< Get pointers - One per each pin */
